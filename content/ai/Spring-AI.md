---
title: 基于Spring AI开发MCP应用
date: 2025-04-18T14:21:26+08:00
lastmod: 2025-04-18T14:21:26+08:00
author: Lin
avatar: /me/yy.jpg
cover: /img/ai.png
images:
...
![spring-ai-alibaba-mcp](https://java2ai.com/img/blog/mcp/1.png)

点开之后可以看到具体的工具内容：

![spring-ai-alibaba-mcp](https://java2ai.com/img/blog/mcp/2.png)

此时我们就可以享受 Github 服务提供的操作仓库的能力：

![spring-ai-alibaba-mcp](https://java2ai.com/img/blog/mcp/3.png)

从图上可以看到，通过创建仓库test-mcp这样的提示词，Claude 的大模型自行判断需要使用 mcp 中提供的create_repository能力，从而完成了仓库的创建，接下来我们打开 Github 也确实发现了这个已经创建的仓库。

![spring-ai-alibaba-mcp](https://java2ai.com/img/blog/mcp/4.png)
...
![spring-ai-alibaba-mcp](https://java2ai.com/img/blog/mcp/5.png)
...
![spring-ai-alibaba-mcp](https://java2ai.com/img/blog/mcp/6.png)
...
服务端将在 [http://localhost:8080](http://localhost:8080/) 启动。
...
![spring-ai-alibaba-mcp](https://java2ai.com/img/blog/mcp/7.png)

输入提示词，查询今天北京的空气质量：

![spring-ai-alibaba-mcp](https://java2ai.com/img/blog/mcp/8.png)

Claude 触发了我们自己编写的天气服务，展示了完整的数据：

![spring-ai-alibaba-mcp](https://java2ai.com/img/blog/mcp/9.png)
...
![spring-ai-alibaba-mcp](https://java2ai.com/img/blog/mcp/10.png)

`SseHttpClientTransportAutoConfiguration`的加载：

![spring-ai-alibaba-mcp](https://java2ai.com/img/blog/mcp/11.png)
...
![spring-ai-alibaba-mcp](https://java2ai.com/img/blog/mcp/12.png)

# 4、在 Spring AI Alibaba 的 Open Manus 中体验 MCP

Spring AI Alibaba 中提供了 Open Manus 的实现，整体架构如下：

![spring-ai-alibaba-mcp](https://java2ai.com/img/blog/mcp/13.jpeg)
...
![spring-ai-alibaba-mcp](https://java2ai.com/img/blog/mcp/14.png)
...
结果： 总距离：约1223公里 预计耗时：约12小时45分钟 主要途径：京沪高速公路（G2）
