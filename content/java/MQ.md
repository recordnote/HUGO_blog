---
title: RockerMQ总结
date: 2023-11-15T14:21:26+08:00
lastmod: 2023-11-23T14:21:26+08:00
author: Lin
avatar: /me/yy.jpg
...
消息队列顾名思义就是存放消息的队列， **消息队列为什么会出现？消息队列能用来干什么？用它来干这些事会带来什么好处？消息队列会带来副作用吗？**
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/12/11/16ef37fee7e09230~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/12/11/16ef380429cf373e~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)

这样整个系统的调用链又变长了，整个时间就变成了550ms。

所以，为了解决这一个问题，聪明的程序员在中间也加了个类似于服务员的中间件——消息队列。这个时候我们就可以把模型给改造了。

![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/12/11/16ef38124f55eaea~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/12/11/16ef381a505d3e1f~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)

那么第二步，我们又添加了一个发送邮件，我们就得重新去修改代码，如果我们又加一个需求：用户购买完还需要给他加积分，这个时候我们是不是又得改代码？

![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/12/11/16ef381c4e1b1ac7~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/12/11/16ef382674b66892~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/12/11/16ef382a9756bb1c~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/12/11/16ef383014430799~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/12/11/16ef3834ae653469~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/12/11/16ef3837887d9a54~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/12/11/16ef383d3e8c9788~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/12/11/16ef3850c808d707~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)

**每个消费组在每个队列上维护一个消费位置** ，为什么呢？

因为我们刚刚画的仅仅是一个消费者组，我们知道在发布订阅模式中一般会涉及到多个消费者组，而每个消费者组在每个队列中的消费位置都是不同的。如果此时有多个消费者组，那么消息被一个消费者组消费完之后是不会删除的(因为其它消费者组也需要呀)，它仅仅是为每个消费者组维护一个 **消费位移(offset)** ，每次消费者组消费完会返回一个成功的响应，然后队列再把维护的消费位移加一，这样就不会出现刚刚消费过的消息再一次被消费了。

![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/12/11/16ef3857fefaa079~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)

可能你还有一个问题，**为什么一个主题中需要维护多个队列** ？

答案是 **提高并发能力** 。的确，每个主题中只存在一个队列也是可行的。你想一下，如果每个主题中只存在一个队列，这个队列中也维护着每个消费者组的消费位置，这样也可以做到 **发布订阅模式** 。如下图。

![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/12/11/16ef38600cdb6d4b~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
- `Broker`： 主要负责消息的存储、投递和查询以及服务高可用保证。说白了就是消息队列服务器嘛，生产者生产消息到 `Broker` ，消费者从 `Broker` 拉取消息并消费。
  ...
  **一个 `Topic` 分布在多个 `Broker`上，一个 `Broker` 可以配置多个 `Topic` ，它们是多对多的关系**。 
  ...
  ![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/12/11/16ef38687488a5a4~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/12/11/16ef386c6d1e8bdb~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/12/11/16ef386fa3be1e53~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/12/11/16ef3874585e096e~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/12/11/16ef38798d7a987f~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/12/11/16ef387d939ab66d~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/12/11/16ef387fba311cda~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/12/11/16ef38823b165817~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/12/11/16ef3884c02acc72~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
...
![img](https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2019/12/11/16ef388763c25c62~tplv-t2oaga2asx-jj-mark:3024:0:0:0:q75.awebp)
